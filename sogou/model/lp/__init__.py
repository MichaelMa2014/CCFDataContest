...
def build(label):
    ...
    """
    feature.bow.flush()
    X_train, y_train, X_val, y_val = process.build_train_set(label, 0.1)
...
def run():
    ...
    submissions.save_csv(test_id, pred_age, pred_gender, pred_education, 'lp.csv')
